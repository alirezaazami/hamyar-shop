                ...
                <div class="card border-0 cu-service">
                    <div class="card-body d-flex flex-column flex-lg-row align-items-center">
                        <div class="flex-grow-1 text-center first">
                            <img src="<?php echo get_theme_file_uri() ?>/assets/img/customer-service.png" class="img-fluid mx-auto d-block" alt="imagehamyarmarket">
                            <a href="#" class="mt-3 d-block"> 021-74553690 </a>
                        </div>
                        <div class="flex-grow-1 text-center second">
                            <img src="<?php echo get_theme_file_uri() ?>/assets/img/email (1).png" class="img-fluid mx-auto d-block" alt="imagehamyarmarket">
